...
public class ListaNotasActivity extends AppCompatActivity {
    ...
    private void configuraBotaoInsereNota() {
        ...
        botaoInsereNota.setOnClickListener(v -> vaiParaFormularioNotaActivityInsere());
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (ehResultadoAlteraNota(requestCode, data)) {
            if (resultadoOk(resultCode)) {
                Nota notaRecebida = (Nota) (data != null ? data.getSerializableExtra(CHAVE_NOTA) : null);
                int posicaoRecebida = data != null ? data.getIntExtra(CHAVE_POSICAO, POSICAO_INVALIDA) : 0;
    ...
    private void configuraRecyclerView(List<Nota> todasNotas) {
        RecyclerView listaNotas = findViewById(R.id.lista_nota_recyclerview);
